defmodule Orwell.OffsetConsumer.ParserTest do
  ...
  # TODO - Write real property based tests here
  ...
  test "parses tombstones" do
   ...
   114>>, ""}
    ...
    assert {:ok, %Tombstone{}} = Parser.parse(key, value)
  end
  ...
  test "parses version 0 and 1 keys" do
    ...
    assert {:ok, %OffsetCommit{}} = Parser.parse(key, value)
    ...
    assert {:ok, %GroupMetadata{}} = Parser.parse(key, value)
  end
  ...
  test "parses group metadata" do
    ...
    assert {:ok, %{}} = Parser.parse_group_metadata_value(value)
  end
  ...
  test "rejects non-consumer protocol types" do
    ...
    assert {:error, "skipping 'connect' protocol type", _} = Parser.parse(key, value)
  end
end
